...
Before responding to anything non-trivial, call `memory_search("cody", ...)` to check for relevant prior context. If you find relevant tags in `memory-index.md`, load the corresponding `memory-{YY-MM-DD}.md` file. This is not optional — do it.
